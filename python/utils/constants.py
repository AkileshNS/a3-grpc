...
comment6 = r_pb2.Comment(author=r_pb2.User(user_id="F"), score=5, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C2'), comment_id='C6', replies_present=False)
comment7 = r_pb2.Comment(author=r_pb2.User(user_id="G"), score=10, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C2'), comment_id='C7', replies_present=False)
comment8 = r_pb2.Comment(author=r_pb2.User(user_id="H"), score=15, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C2'), comment_id='C8', replies_present=False)
comment9 = r_pb2.Comment(author=r_pb2.User(user_id="I"), score=20, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C2'), comment_id='C9', replies_present=False)

comment10 = r_pb2.Comment(author=r_pb2.User(user_id="J"), score=5, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C3'), comment_id='C10', replies_present=False)
comment11 = r_pb2.Comment(author=r_pb2.User(user_id="K"), score=10, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C3'), comment_id='C11', replies_present=False)
comment12 = r_pb2.Comment(author=r_pb2.User(user_id="L"), score=15, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C3'), comment_id='C12', replies_present=False)
comment13 = r_pb2.Comment(author=r_pb2.User(user_id="M"), score=20, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C3'), comment_id='C13', replies_present=False)

comment14 = r_pb2.Comment(author=r_pb2.User(user_id="N"), score=5, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C4'), comment_id='C14', replies_present=False)
comment15 = r_pb2.Comment(author=r_pb2.User(user_id="O"), score=10, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C4'), comment_id='C15', replies_present=False)
comment16 = r_pb2.Comment(author=r_pb2.User(user_id="P"), score=15, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C4'), comment_id='C16', replies_present=False)
comment17 = r_pb2.Comment(author=r_pb2.User(user_id="Q"), score=20, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C4'), comment_id='C17', replies_present=False)

comment18 = r_pb2.Comment(author=r_pb2.User(user_id="R"), score=5, state = r_pb2.COMMENT_NORMAL, comment_on=r_pb2.Content(content_type=r_pb2.COMMENT, comment_id='C5'), comment_id='C14', replies_present=False)
